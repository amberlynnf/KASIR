...
<body>
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <form action="" method="POST" class="row d-flex align-items-center">
                            ...
                            <input type="text" id="nama" placeholder="masukan nama barang" name="nama"
                                class="form-control mb-2">

                            <label for="kode">Kode Barang</label>
                            <input type="number" id="kode" placeholder="masukan kode barang" name="kode"
                                class="form-control mb-2">

                            <label for="harga">Harga</label>
                            <input type="number" id="harga" placeholder="masukan harga barang" name="harga"
                                class="form-control mb-2">

                            <label for="jumlah">Jumlah Barang</label>
                            <input type="number" id="jumlah" placeholder="masukan jumlah barang" name="jumlah"
                                class="form-control mb-2">
    ...
    if (isset($_POST['selesai'])) {
        ...
        if ($bayar >= $totalHarga) {
            ...
            echo "<div class='alert alert-danger text-center'>Maaf, Uang anda tidak cukup.</div>";
        }
    }
    ?>
</body>
